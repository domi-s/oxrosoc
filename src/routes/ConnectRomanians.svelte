<script>
    ...
    import oxrosocEvent1 from "$lib/assets/oxrosoc-event-1.jpg";
</script>

<section>
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-8 sm:py-16">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            <div class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
                <img alt="OxRoSoc Formal Event" src="{emptyImage}" data-src="{oxrosocEvent1}" class="absolute inset-0 h-full w-full object-cover" />
            </div>
